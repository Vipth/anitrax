  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "anim-popover fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-surface-raised shadow-2xl shadow-black/30 outline-none",
          className,
        )}
        {...props}
      >
...
export function DialogHeader({
  ...
  return (
    <div className={cn("border-b border-border px-5 py-3.5", className)} {...props} />
  );
}
